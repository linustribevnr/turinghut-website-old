...
export default function AboutTuringCup() {
  return (
    <div className=" pt-12 bg-secondary h-100v">
      <div className="text-white">
        <div className="text-4xl md:text-5xl p-3 text-center text-white">
          <h1 className="p-2">Turing Cup</h1>
          <h1 className="p-2">One Team, One Dream</h1>
        </div>
        <div className="flex-about-reverse items-center justify-center bg-secondary">
